...
from .views import get_usernames, create_usernames, usernames_detail, create_multiple_usernames, bulk_create_laptimes, save_race_session, leaderboard_view, save_laps
from . import views
...
urlpatterns = [
    ...
    path('save-laps/', save_laps, name='save_laps'),
